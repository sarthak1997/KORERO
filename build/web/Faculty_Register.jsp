                    ...
                    <div class="card-block">
                        ...
                        <div class="md-form wow fadeInDown">
                            ...
                            <li class="nav-item btn-group">
                                <a class="nav-link dropdown-toggle ml-5" id="dropdownMenu1" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Department</a>
                                <div class="dropdown-menu" aria-labelledby="dropdownMenu1">
                                    ...
                                    <a class="dropdown-item" id="tpo" onclick="myfunct1(this.id);dep();">Training and Placement Cell</a>
                                    <a class="dropdown-item" id="other" onclick="myfunct1(this.id);dep();">Other</a>
...
function setAction()
{
    ...
    document.getElementById("studentform").setAttribute("action","SaveTempUser?utype=Faculty&branch="+dept+"&sque="+sque);
}
    </script>
...
{   
    ...
    var data="email="+id+"&utype=faculty";
    request.send(data);
}
